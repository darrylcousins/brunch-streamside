...
const ShowLink = (opts) => {
  ...
  return (
    <IconButton color={color} title={title} name={name}>
      <span style="width: 250px" class="db tl link f5 white pv1 pl3 pr2">Create a core box</span>
    </IconButton>
  );
};
 ...
 */
async function* AddCoreBox(props) {
   ...
   */
  let fields = {
    Box : { // selected from product list
...
export default FormModalWrapper(AddCoreBox, options);
